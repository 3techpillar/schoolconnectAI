...
| # | Task | Status |
|---|------|--------|
| 4 | Parent↔student link UI on profile (`/api/links`) | open |
| 5 | Resolve child context via `ParentStudentLink` (attendance/AI/home) | open |
| 6 | Principal ↔ `/admin` UI alignment | open |
