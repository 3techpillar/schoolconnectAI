  ...
  if (!bus.ready) {
    return (
      <div className="app-shell">
        <LoadingBlock label="Loading live bus…" splash />
      </div>
    );
  }
    ...
    <PhoneShell showHeader={false}>
      ...
      <div className="map-wrap">
        ...
        >
          <MapCanvas
            ...
            currentId={bus.stops.find((s) => s.status === "current")?.id}
          />
        </div>
      ...
      <section className="sheet">
        ...
        <div className="page-x row" style={{ paddingBottom: "1rem" }}>
          ...
          <Link href="/chats" className="wa-btn" aria-label="Message">
            <MessageCircle size={20} />
          </Link>
          <a href={`tel:${driverPhone}`} className="call-btn" aria-label="Call driver">
            <Phone size={20} />
          </a>
        </div>
