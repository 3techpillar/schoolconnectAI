...
export const Bus = (p: IconProps) => (
  <Icon {...p}>
    ...
    <path d="M15 6v6" />
    <path d="M2 12h19.6" />
    <path d="M18 18h3s.5-1.7.8-2.8c.1-.4.2-.8.2-1.2 0-.4-.1-.8-.2-1.2l-1.1-3.4A3 3 0 0 0 17.9 8H6a3 3 0 0 0-2.8 1.6l-1.1 3.4c-.1.4-.2.8-.2 1.2 0 .4.1.8.2 1.2.3 1.1.8 2.8.8 2.8h3" />
